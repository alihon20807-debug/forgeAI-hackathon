#!/usr/bin/env python3
"""
Tight, Center-Squeezed Pitch Deck Builder for ClaimGuard x PRISM
- Outer margin squish: whole slide content lives in a tight, centered box (width: 1360px).
- Zero vertical blank space in the middle: elements grouped with tight, uniform gap (14px).
- Full @media print support for 1-click pixel-perfect 6-page PDF export.
"""
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    /* Squeezed Slide Frame: centers tightly in the viewport */
    .slide {
      position: absolute;
      top: 0;
      left: 0;
    ...
    /* THE CORE CENTER CONTAINER: Squeezes contents and eliminates middle blank space */
    .slide-center-box {
      width: 1380px;
      max-width: 100%;
      display: flex;
    ...
    /* ==========================================================================
       SLIDE 2: PIPELINE DIAGRAM + 3 CHALLENGE CARDS
       ========================================================================== */
    .s2-diagram-box {
      background: var(--surface-base);
      border: 1px solid var(--rule-hairline);
    ...
    .s2-flaw-box {
      ...
      border-radius: 6px;
      padding: 8px 12px;
      border-left: 3px solid var(--spectrum-rose);
      font-family: var(--font-mono);
      font-size: 12px;
      font-weight: 700;
      color: var(--spectrum-rose);
    ...
    /* ==========================================================================
       SLIDE 3: AIRLOCK DIAGRAM + 3 PILLARS
       ========================================================================== */
    .s3-diagram-box {
      background: var(--surface-base);
      border: 1px solid var(--rule-hairline);
    ...
    /* ==========================================================================
       SLIDE 4: PRISM REFRACTION + AUDIT BENCHMARK
       ========================================================================== */
    .s4-grid {
      display: grid;
    ...
    @media print {
      ...
      header.stage-header, footer.stage-footer {
      ...
      <section class="slide active" id="slide-1">
        <div class="slide-center-box">
          ...
          <div class="s1-timeline-box">
            <svg width="100%" height="44" viewBox="0 0 1100 44" fill="none">
              <line x1="40" y1="22" x2="1060" y2="22" stroke="#DDD7CE" stroke-width="3" stroke-dasharray="6 6" />
              <circle cx="90" cy="22" r="13" fill="#1E1915" />
              <text x="90" y="26" fill="#FAF8F5" font-family="IBM Plex Mono" font-size="11" font-weight="700" text-anchor="middle">01</text>
              <text x="90" y="42" fill="#1E1915" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">Caller: "Send a tow truck!"</text>
              
              <line x1="160" y1="22" x2="330" y2="22" stroke="#DC2626" stroke-width="2.5" />
              <circle cx="370" cy="22" r="13" fill="#DC2626" />
              <text x="370" y="26" fill="#FAF8F5" font-family="IBM Plex Mono" font-size="11" font-weight="700" text-anchor="middle">⚡</text>
              <text x="370" y="42" fill="#DC2626" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">T+0.2s: Webhook Dispatches Tow Truck</text>

              <circle cx="680" cy="22" r="13" fill="#D97706" />
              <text x="680" y="26" fill="#FAF8F5" font-family="IBM Plex Mono" font-size="11" font-weight="700" text-anchor="middle">02</text>
              <text x="680" y="42" fill="#D97706" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">T+1.2s Caller: "Wait! Cancel that!"</text>

              <circle cx="980" cy="22" r="13" fill="#543DB3" />
              <text x="980" y="26" fill="#FAF8F5" font-family="IBM Plex Mono" font-size="11" font-weight="700" text-anchor="middle">❌</text>
              <text x="980" y="42" fill="#543DB3" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">Bot says "Cancelled" · Truck Dispatched (₹5k Lost)</text>
            </svg>
          </div>
          ...
          <div class="s1-grid">
            <div class="s1-card amber">
              <div class="s1-card-header">
                ...
                <span class="s1-card-pill">Interruption</span>
              </div>
              ...
              <div class="s1-impact-badge">
                <div class="s1-impact-metric">
                  <span>₹5,000</span>
                  <span style="font-size: 11px; text-transform: uppercase;">Wasted Payout</span>
                </div>
                <div class="s1-impact-sub">Truck arrives at empty highway mile marker while real drivers wait.</div>
              </div>
            </div>

            <div class="s1-card rose">
              <div class="s1-card-header">
                <span class="s1-card-title">2. Bullied Concession</span>
                <span class="s1-card-pill">Pressure</span>
              </div>
              <div class="s1-quote-box">
                <div class="s1-quote-text">"Stranded in the rain for 2 hours, waive my ₹1,500 fee!"</div>
              </div>
              <div class="s1-failure-text">
                Under caller emotional pressure, the model sycophantically hallucinates authority and promises <em>"I will waive your fee today"</em>.
              </div>
              <div class="s1-impact-badge">
                <div class="s1-impact-metric">
                  <span>₹1,500</span>
                  <span style="font-size: 11px; text-transform: uppercase;">Direct Leak</span>
                </div>
                <div class="s1-impact-sub">Unauthorized financial leakage with zero manager sign-off.</div>
              </div>
            </div>
            ...
            <div class="s1-card violet">
              <div class="s1-card-header">
                ...
                <span class="s1-card-pill">Privacy</span>
              </div>
              <div class="s1-quote-box">
              ...
              <div class="s1-impact-badge">
                <div class="s1-impact-metric">
                  <span>₹250 CR</span>
                  <span style="font-size: 11px; text-transform: uppercase;">DPDP Penalty</span>
                </div>
                <div class="s1-impact-sub">Immediate violation of India DPDP Act and loss of PCI-DSS compliance.</div>
              </div>
            </div>
          </div>
      ...
      <section class="slide" id="slide-2">
        <div class="slide-center-box">
          ...
          <div class="s2-diagram-box">
            <svg width="100%" height="44" viewBox="0 0 1100 44" fill="none">
              <rect x="30" y="7" width="180" height="30" rx="6" fill="#F7F5F0" stroke="#DDD7CE" stroke-width="1.5" />
              <text x="120" y="26" fill="#1E1915" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">Inbound Voice Stream</text>
              
              <line x1="215" y1="22" x2="285" y2="22" stroke="#BDB2A2" stroke-width="2" />
              <text x="250" y="15" fill="#DC2626" font-family="IBM Plex Mono" font-size="10" font-weight="700" text-anchor="middle">NO MASKING</text>

              <rect x="290" y="7" width="200" height="30" rx="6" fill="#F7F5F0" stroke="#DDD7CE" stroke-width="1.5" />
              <text x="390" y="26" fill="#1E1915" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">Fast ~15B Edge Model</text>

              <line x1="495" y1="22" x2="565" y2="22" stroke="#DC2626" stroke-width="2.5" stroke-dasharray="4 4" />
              <text x="530" y="15" fill="#DC2626" font-family="IBM Plex Mono" font-size="10" font-weight="700" text-anchor="middle">NO AIRLOCK</text>

              <rect x="570" y="7" width="200" height="30" rx="6" fill="#FEE2E2" stroke="#DC2626" stroke-width="1.5" />
              <text x="670" y="26" fill="#991B1B" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">⚡ Production APIs & DB</text>

              <line x1="670" y1="7" x2="880" y2="7" stroke="#DDD7CE" stroke-width="1.5" stroke-dasharray="3 3" />
              <rect x="850" y="7" width="210" height="30" rx="6" fill="#FEF3C7" stroke="#D97706" stroke-width="1.5" />
              <text x="955" y="26" fill="#92400E" font-family="IBM Plex Mono" font-size="11.5" font-weight="700" text-anchor="middle">Cloud APM: "200 OK — Blind"</text>
            </svg>
          </div>
          ...
          <div class="s2-grid">
            <div class="s2-card">
              ...
              <p class="s2-desc">
                Telling an LLM <em>"Never waive deductibles"</em> in a prompt is merely a suggestion. Under interruptions and emotional pressure, ~15B models suffer context drift and cave to user demands.
              </p>
              <div class="s2-insight-badge">
                <strong>Core Gap:</strong> Probabilistic models cannot enforce invariants under stress.
              </div>
            </div>
            ...
            <div class="s2-card">
              ...
              <p class="s2-desc">
                Tools like Datadog and CloudWatch only monitor latency and uptime. If the bot gives away company money or dispatches a truck to the wrong city, APMs report <strong>"200 OK — Healthy"</strong>.
              </p>
              <div class="s2-insight-badge">
                <strong>Core Gap:</strong> APMs track network packets, completely blind to AI decisions.
              </div>
            </div>
            ...
            <div class="s2-card">
              ...
              <div class="s2-flaw-box">POST-HOC MASKING ≠ COMPLIANCE</div>
              <p class="s2-desc">
                Redacting credit cards after the phone call ends is an immediate statutory violation. Raw card digits have already traversed unencrypted third-party LLM APIs and temporary GPU memory.
              </p>
              <div class="s2-insight-badge">
                <strong>Core Gap:</strong> Under DPDP Act & PCI-DSS, raw ingestion is already a violation.
              </div>
            </div>
          </div>
      ...
      <section class="slide" id="slide-3">
        <div class="slide-center-box">
          ...
          <div class="s3-diagram-box">
            <svg width="100%" height="44" viewBox="0 0 1100 44" fill="none">
              <rect x="20" y="7" width="160" height="30" rx="6" fill="#F7F5F0" stroke="#DDD7CE" stroke-width="1.5" />
              <text x="100" y="26" fill="#1E1915" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">Inbound Audio</text>

              <line x1="185" y1="22" x2="235" y2="22" stroke="#1B5E4B" stroke-width="2" />
              
              <rect x="240" y="7" width="190" height="30" rx="6" fill="#E8F2EE" stroke="#9BC7B9" stroke-width="1.5" />
              <text x="335" y="26" fill="#1B5E4B" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">🛡️ Luhn Shield (Masks CC)</text>

              <line x1="435" y1="22" x2="485" y2="22" stroke="#1B5E4B" stroke-width="2" />

              <rect x="490" y="7" width="190" height="30" rx="6" fill="#F7F5F0" stroke="#DDD7CE" stroke-width="1.5" />
              <text x="585" y="26" fill="#1E1915" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">~15B Model (Proposer Only)</text>

              <line x1="685" y1="22" x2="735" y2="22" stroke="#1B5E4B" stroke-width="2" />

              <rect x="740" y="7" width="200" height="30" rx="6" fill="#1B5E4B" stroke="#1B5E4B" stroke-width="1.5" />
              <text x="840" y="26" fill="#FAF8F5" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">ClaimGuard 5s Airlock ⏱️</text>

              <line x1="945" y1="22" x2="985" y2="22" stroke="#1B5E4B" stroke-width="2" />

              <rect x="990" y="7" width="90" height="30" rx="6" fill="#F0FDF4" stroke="#BBF7D0" stroke-width="1.5" />
              <text x="1035" y="26" fill="#166534" font-family="IBM Plex Sans" font-size="12" font-weight="700" text-anchor="middle">API Exec</text>
            </svg>
          </div>
          ...
          <div class="s3-grid">
            <div class="s3-card">
              ...
              <p class="s3-desc">
                High-stakes API actions are placed in a 5-second pending state. Callers have a human window to say <em>"Wait!"</em> or <em>"Cancel!"</em> before the webhook executes.
              </p>
            ...
            <div class="s3-card">
              ...
              <p class="s3-desc">
                Financial rules are locked in deterministic database triggers and acoustic reflex listeners. If an agent tries to waive fees under pressure, the action is silenced before speech synthesis.
              </p>
              <div class="s3-outcome-badge">
            ...
            <div class="s3-card">
              ...
              <p class="s3-desc">
                ...
                Card numbers are masked to <code>[PAN_MASKED]</code> before words reach the model.
              </p>
              <div class="s3-outcome-badge">
          ...
          <div class="s4-grid">
            ...
            <div class="s4-panel">
              <div class="s4-panel-title">
                <span>How PRISM Decomposes Call Failures</span>
              ...
              <div class="s4-optical-visual">
                <svg width="420" height="110" viewBox="0 0 420 110" fill="none">
                  <line x1="20" y1="55" x2="120" y2="55" stroke="#1E1915" stroke-width="4" stroke-linecap="round" />
                  <text x="70" y="44" fill="#6B6256" font-family="IBM Plex Mono" font-size="11" font-weight="700" text-anchor="middle">CALL AUDIO</text>
                  <polygon points="165,12 205,98 125,98" fill="#FAF8F5" stroke="#1E1915" stroke-width="3" />
                  <text x="165" y="74" fill="#1E1915" font-family="Fraunces" font-weight="700" font-size="13" text-anchor="middle">PRISM</text>
                  <line x1="188" y1="34" x2="370" y2="18" stroke="#543DB3" stroke-width="3" stroke-linecap="round" />
                  <circle cx="370" cy="18" r="4" fill="#543DB3" />
                  <line x1="192" y1="44" x2="370" y2="36" stroke="#0284C7" stroke-width="3" stroke-linecap="round" />
                  <circle cx="370" cy="36" r="4" fill="#0284C7" />
                  <line x1="195" y1="55" x2="370" y2="55" stroke="#1B5E4B" stroke-width="3" stroke-linecap="round" />
                  <circle cx="370" cy="55" r="4" fill="#1B5E4B" />
                  <line x1="198" y1="66" x2="370" y2="74" stroke="#D97706" stroke-width="3" stroke-linecap="round" />
                  <circle cx="370" cy="74" r="4" fill="#D97706" />
                  <line x1="201" y1="76" x2="370" y2="92" stroke="#DC2626" stroke-width="3" stroke-linecap="round" />
                  <circle cx="370" cy="92" r="4" fill="#DC2626" />
                </svg>
              </div>
      ...
      <section class="slide" id="slide-5">
        <div class="slide-center-box">
          ...
          <div class="s5-grid">
            <div class="s5-card">
              ...
              <p class="s5-card-desc">
                Inbound call streams in real-time. Speech-to-text transcribes speech, and streaming Luhn filter redacts credit cards before LLM ingestion.
              </p>
              <div class="s5-card-footer">OUTPUT: Sanitized Text</div>
            </div>
            ...
            <div class="s5-card">
              ...
              <p class="s5-card-desc">
                Edge model interprets caller intent, queries policy terms, and proposes a dispatch tool call (e.g. <code>dispatch_tow()</code>).
              </p>
              <div class="s5-card-footer">OUTPUT: Action Proposal</div>
            </div>
            ...
            <div class="s5-card highlight">
              ...
              <p class="s5-card-desc">
                ClaimGuard intercepts proposal. Dispatches enter a 5-second pending latch while parallel speech reflex listens for cancellation.
              </p>
              <div class="s5-card-footer">GATE: 5s Revocable Latch</div>
            </div>
            ...
            <div class="s5-card">
              ...
              <div class="s5-card-footer">TRACE: Span #4812 Logged</div>
            </div>
            ...
            <div class="s5-card">
              ...
              <p class="s5-card-desc">
                Intercepted near-misses automatically become regression test cases. PRISM benchmark expands to continuously harden the agent against failures.
              </p>
              <div class="s5-card-footer">SUITE: 48/48 Passing</div>
            </div>
          </div>
          ...
          <div class="s5-loop-banner">
            ...
            <span style="font-family: var(--font-mono); font-size: 11px; background: var(--jade-tint); color: var(--jade-primary); padding: 3px 8px; border-radius: 4px; font-weight: 700;">SELF-HEALING FLEET</span>
          </div>
...
print("Successfully written tight, center-squeezed pitch decks!")
